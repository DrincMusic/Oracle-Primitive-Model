...
amendment_version: 1.1.0-candidate
base_specification_version: 1.0.0
charter_version: 1.2.0
lifecycle_state: AMENDMENT_REVIEW
approval_status: PENDING_OWNER_CONFIRMATION
scientific_core_status: BLOCKED_PENDING_AMENDMENT_APPROVAL
...
Until then, an implementation agent must stop before changing the binding algorithm or generating
v1.1 canonical data.
